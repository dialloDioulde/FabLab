...
class CreateCrudLoaner(View):
    def  get(self, request):
        ...
        obj = Loaner.objects.create(last_name = last_name, first_name = first_name, email = email, establishment = establishment)
...
class UpdateCrudLoaner(View):
    def  get(self, request):
        ...
        loaner = {'id':obj.id_loaner,'last_name':obj.last_name,'first_name':obj.first_name,'email':obj.email, 'establishment':obj.establishment}
